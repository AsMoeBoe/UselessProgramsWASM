namespace UselessProgramsWASM
{
    //Kopieret direkte fra https://github.com/formalatist/Perlin/tree/master, jeg har kun tilføjet en ny constructor
   ...
   138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180};
    ...
    public class Perlin : Perlin<Perlin.Vector3>
    {
        ...
        public Perlin(int seed) : this(SmoothToSCurve) //Jeg har tilføjet denne constructor
        {
            Random r = new Random(seed);
            SetPermutationTable(new int[512].Select((element) => element = r.Next(256)).ToArray());
        }
